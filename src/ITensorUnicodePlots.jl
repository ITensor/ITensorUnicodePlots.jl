...
import ITensorVisualizationBase: default_newlines, visualize
using ITensorVisualizationBase: @Backend_str, default_arrow_show, default_arrow_size,
    default_edge_labels, default_edge_textsize, default_edge_widths,
    default_siteinds_direction, default_vertex_labels, default_vertex_labels_prefix,
    default_vertex_size, default_vertex_textsize, is_self_loop
